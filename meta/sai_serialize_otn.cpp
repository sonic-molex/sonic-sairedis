        ...
        _In_ const sai_otn_wss_attr_t counter)
{
    ...
    return sai_serialize_enum(counter, &sai_metadata_enum_sai_otn_wss_attr_t);
}
        ...
        _Out_ sai_otn_wss_attr_t& attr)
{
    ...
    sai_deserialize_enum(s, &sai_metadata_enum_sai_otn_wss_attr_t, (int32_t&)attr);
}
        ...
        _In_ const sai_otn_wss_spec_power_attr_t counter)
{
    ...
    return sai_serialize_enum(counter, &sai_metadata_enum_sai_otn_wss_spec_power_attr_t);
}
        ...
        _Out_ sai_otn_wss_spec_power_attr_t& attr)
{
    ...
    sai_deserialize_enum(s, &sai_metadata_enum_sai_otn_wss_spec_power_attr_t, (int32_t&)attr);
}
