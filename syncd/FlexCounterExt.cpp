...
const std::string FlexCounterExt::COUNTER_TYPE_OTN_ATTENUATOR_ATTR = "OTN Attenuator Attributes Counter";
const std::string FlexCounterExt::COUNTER_TYPE_OTN_OA_ATTR = "OTN OA Attributes Counter";
const std::string FlexCounterExt::COUNTER_TYPE_OTN_OCM_CHANNEL_ATTR = "OTN OCM Channel Attributes Counter";
const std::string FlexCounterExt::COUNTER_TYPE_OTN_OSC_ATTR = "OTN OSC Attributes Counter";
